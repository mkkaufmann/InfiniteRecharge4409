...
class Flywheel {
    ...
    static final double SPEED_TRANSFER_TO_BALL = 0.55;
    static final double WHEEL_DIAMETER = 6.0;
    static final double WHEEL_CIRCUMFERENCE = Math.PI * WHEEL_DIAMETER;
    static final double FLYWHEEL_ANGLE_RADIANS = Math.toRadians(29);
    static final double FIRING_HEIGHT_INCHES = 25;
    ...
    public Flywheel(){
        ...
        flywheelMaster.config_kP(0, 20);
        flywheelMaster.config_kF(0, 3.08);
        //2.78443113772
    ...
    public void runVelocity(double velocity){
        ...
        flywheelMaster.set(ControlMode.Velocity, -Math.abs(velocity));
    }
